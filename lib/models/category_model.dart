...
//   List<Null>? get childes => _childes;
//   set childes(List<Null>? childes) => _childes = childes;
...
//         _childes!.add(new Null.fromJson(v));
//       });
//     }
...
//         _storage!.add(new Null.fromJson(v));
//       });
//     }
//   }
//
...
//     if (this._childes != null) {
//       data['childes'] = this._childes!.map((v) => v.toJson()).toList();
//     }
...
//       data['storage'] = this._storage!.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
// }
